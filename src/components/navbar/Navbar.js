...
export default function Navbar(){
    return(
        <nav className="navbar d-flex navbar-expand-lg fixed-top row">
            ...
            <a className="navbar-brand" href="www.google.com"><span className="company-name">Parser</span><span className="domain-name">.io</span></a>
            <div className="collapse navbar-collapse row" id="navbarToggler">
                <ul className="nav-items navbar-nav col-sm-6">
                    <a className="btn nav-button" href="/">Features</a>
                    <a className="btn nav-button" href="/">Pricing</a>
                    <a className="btn nav-button" href="/">Contact Us</a>
                </ul>
